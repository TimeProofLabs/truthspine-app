...
1. Get TruthSpine from [Microsoft Store](https://apps.microsoft.com/detail/9pbn25k75vdj) or the [Mac App Store](https://apps.apple.com/app/id6794478470).
...
TruthSpine supports VS Code, GitHub Copilot in VS Code, Claude Desktop, Claude Code, Cursor, Codex, Google Antigravity, Windsurf / Devin, Open WebUI, LM Studio, Continue, Cline, Roo Code, Kiro, JetBrains IDEs, Zed, Hermes Agent, OpenClaw, OpenCode, GitHub Copilot CLI, Droid, Pi, OpenClaw Desktop.
